...
class SilentPaymentsMixin:
    ...
    def _process_silent_payments(self, sv):
        ...
        if not self._compute_and_store_proof_entries(sv):
            return False
        ...
        for scan_key in scan_keys:
            ...
            if not has_global:
                for i, inp in enumerate(self.inputs):
                    ...
                    if eligible and not has_share and scan_key_has_script:
    ...
    def _compute_and_store_proof_entries(self, sv):
        ...
        for scan_key in scan_keys:
            if all_inputs_ours:
                ...
                self._store_proof_entry(combined_sk.to_bytes(32, "big"), scan_key, self.sp_global_ecdh_shares, self.sp_global_dleq_proofs)
            else:
